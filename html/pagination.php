...
function pagination_list_render($list)
{
	...
	$html = '<ul class="pie-pagination__list">';
...
function pagination_item_active(&$item)
{
	...
	if ($item->text == JText::_('JLIB_HTML_START'))
	{
		...
		$class   = ' class="pie-pagination__list__item bubble-button"';
	}
...
function pagination_item_inactive(&$item)
{
	...
	{
		return '<li class="active pie-pagination__list__item bubble-button"><a>' . $item->text . '</a></li>';
	}

	// Doesn't match any other condition, render a normal item
	return '<li class="disabled pie-pagination__list__item bubble-button"><a>' . $item->text . '</a></li>';
}
