...
;// CONCATENATED MODULE: ./src/modules/reveal-content/index.js
  ...
  function collectItems() {
    ...
    Array.from(document.querySelectorAll(selector)).forEach(function (item) {
      ...
      if (scroll > displayHeight) {
        var openButton = (0,dist.createElement)("button.reveal-content-open.active[data-reveal=\"".concat(id, "\"]"), "•••");
        var closeButton = (0,dist.createElement)("button.reveal-content-close[data-reveal=\"".concat(id, "\"]"), "×");
...
;// CONCATENATED MODULE: ./src/joomla/html/mod_finder_results/default/results.js
// Modules.
...
pistacja_plugin.plugin(function Results(_ref) {
  var domain = _ref.domain;
  customSelect(); // Handle USPP Modal.

  usppModal(domain); // Search results overflow tooltip.

  var reveal = revealContent(".pie-results-result-row-description", 48);
  reveal && window.addEventListener("resize", debounce(function () {
    return reveal.reset();
  }, 400));
});
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [736], () => (__webpack_require__(325)))
