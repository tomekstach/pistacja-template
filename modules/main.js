...
;// CONCATENATED MODULE: ./src/modules/lsm/index.js
function createLSM() {
  var api = {};
...
function Modals() {
  var currentModal;
  var listeners = [];
  var root = document.querySelector("div.pie-modal-root") || (0,dist.createElement)("div.pie-modal-root");
  ...
  var modals = Array.from(document.querySelectorAll("*[data-pie-modal]")).reduce(function (acc, modal) {
    ...
    if (scrollContent) {
      new perfect_scrollbar_esm/* default */.Z(scrollContent);
    }
...
function remoteModal(modalName) {
  ...
  var trigger = $(selector) || createElement(selector);
...
;// CONCATENATED MODULE: ./src/modules/pistacja/feedback/index.js
...
;// CONCATENATED MODULE: ./src/modules/orientation-tracker/index.js
...
document.addEventListener("DOMContentLoaded", /*#__PURE__*/(0,asyncToGenerator/* default */.Z)( /*#__PURE__*/regenerator_default().mark(function _callee() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          lsm = createLSM(); // Handle system Messages.
